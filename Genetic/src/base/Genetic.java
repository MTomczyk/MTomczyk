...
public class Genetic implements IGenetic
{
    public static class Params
    {
        public int _populationSize = 100;
        public int _populationResize = 200;
        ...
        public Params clone()
        {
            ...
            p._populationResize = this._populationResize;
    ...
    private int _populationResized = 0;
    ...
    public Genetic(Params params)
    {
        ...
        this._populationResized = params._populationResize;
        this._specimen = new ArrayList<>(this._populationResized);
    ...
    public void select()
    {
        ...
        if (_selector != null)
        {
            int number = this._populationResized - this._populationSize;
            ...
            if (this._sorter.getReproductionPool() == null)
            {
                _selection = this._selector.select(this.getSpecimens(), number, generator);
            }
            else
            {
    ...
    public void reproduce(Integer generation)
    {
        ...
        for (int i = 0; i < number; i++)
            this._specimen.add(reproduction.get(i));
    ...
    {
        long startTime = System.nanoTime();
        int number = this._specimen.size() - this._populationSize;
