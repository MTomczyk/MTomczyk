 ...
 */
public class MinMaxReverseNormalization implements INormalization
{
    private double min = 0.0d;
    private double max = 1.0d;
    private double diff = 1.0d;
    private double swapThreshold = 0.0d;
     ...
     * Min = 0.0d;
     */
    public MinMaxReverseNormalization()
    {
     ...
     * @param max Max value.
     */
    public MinMaxReverseNormalization(double min, double max, double swapThreshold)
    {
    ...
    {
        return swapThreshold - ((value - min) / diff);
    }
