...
public class MainDataGetter
{
    ...
    public MainDataGetter()
    {
        ...
        costMap.put("tp_space", new Range(825500.0f*1.0f, 956800.0f));
        ...
        co2Map.put("tp_space", new Range(537900.0f*1.0f, 621400.0f));
        ...
        pmMap.put("tp_space", new Range(4400.0f*1.0f, 27600.0f));
    ...
    public ArrayList<IGenetic> getGenetic(ArrayList<Object> params, int t)
    {
        ...
        // TP-NSGA-II
        {
            double _t[] = new double[]{0.005,0.005,0.005};
