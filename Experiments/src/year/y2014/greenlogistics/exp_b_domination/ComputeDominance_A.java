        ...
        for (String s: algs)
        {
            ...
            for (int t = 0; t < toRead; t++)
            {
                ...
                else
                {
                    ...
                    if (s.equals("ECM")) cData = Separate.dataECM_A;
                    else if (s.equals("ADAPT-WSM")) cData = Separate.dataWSM_ADAPT_A;
                    else if (s.equals("ADAPT-ECM")) cData = Separate.dataECM_ADAPT_A;
