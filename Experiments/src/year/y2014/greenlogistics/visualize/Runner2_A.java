...
public class Runner2_A
{
    ...
    public static void main(String args[])
    {
        ...
        costMap.put("tp_space", new Range(843700.0f*0.0d, 1032700.0f));
        ...
        co2Map.put("tp_space", new Range(535100.0f*0.0d, 570600.0f));
        ...
        pmMap.put("tp_space", new Range(2700.0f*0.0d, 14800.0f));
