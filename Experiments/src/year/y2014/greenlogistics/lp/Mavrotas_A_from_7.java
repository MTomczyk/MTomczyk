 ...
 */
public class Mavrotas_A_from_7
{
        ...
        for (int trial = 0; trial < trials; trial++)
        {
            ...
            for (int step = 0; step < steps; step++)
            {
                ...
                ArrayList<IAlternative> alternatives = new ArrayList<>(7);
                {
                    ...
                    normalizations.add(new MinMaxNormalization(ranges.get(0).left, ranges.get(0).right));
                    normalizations.add(new MinMaxNormalization(ranges.get(1).left, ranges.get(1).right));
                    normalizations.add(new MinMaxNormalization(ranges.get(2).left, ranges.get(2).right));
