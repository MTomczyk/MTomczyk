...
public class adaptiveECM_B
{
    ...
    public static void main(String args[])
    {
        ...
        double minA[] = {(zm[0] - zi[0]) / 46.0d, (zm[1] - zi[1]) / 46.0d, (zm[2] - zi[2]) / 46.0d};
        double maxD[] = {(zm[0] - zi[0]) / 46.0d, (zm[1] - zi[1]) / 46.0d, (zm[2] - zi[2]) / 46.0d};
    ...
    public static Double[] getSolution(LPBox box, int criterion, double minA[], double maxD[])
    {
        ...
        Constraints_B.addECMObjective(problem, data, criterion, U1, U2, eps,
                box.lower[0] + 0.0d,
                box.upper[0] - maxD[0],
                box.lower[1] + 0.0d,
                box.upper[1] - maxD[1],
