 ...
 */
public class Constraints_B
{

    public static void addECMObjective(Problem problem, DataB d, int criterion,
    ...
    public static void addWSMObjective(Problem problem, DataB d, double w1, double w2, double w3,
    ...
    public static void addConstraints(Problem problem, DataB d ) {
        Linear linear;
        // FLOW CONSTR.
    ...
    public static double[] eval(Result r, DataB d) {
        boolean log = false;
