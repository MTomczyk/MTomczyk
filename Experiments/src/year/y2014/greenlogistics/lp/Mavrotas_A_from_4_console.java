 ...
 */
public class Mavrotas_A_from_4_console
{
    public static void main(String args[])
    {
        ...
        for (int step = 0; step < steps; step++)
        {
            ...
            ArrayList<IAlternative> alternatives = new ArrayList<>(7);
            {
                ...
                {
                    min = Common.MAX_DOUBLE;
                    double reference = ranges.get(i).left + ranges.get(i).getRange() / 4.0d;
                    for (ISpecimen s: pareto)
                    {
                        double e = s.getAlternative().getEvaluationAt(criteria.get(i));
                        if (Math.abs(e - reference) < min)
                        {
                            min = Math.abs(e - reference);
                            tmp = s;
                        }
                    }
                    //alternatives.add(tmp.getAlternative());
        ...
        String path = "Results/year/y2015/greenlogistics/11_2015/mavrotas_4/";
